...
export function GoalManager(props: Props) {
  ...
  return (
    <GoalManagerContainer>
      ...
      <AddIconButtonContainer hasIcon={hasIcon()} onClick={addIconOnClick}></AddIconButtonContainer>
...
type AddIconButtonContainerProps = { hasIcon: boolean, onClick: (event: React.MouseEvent) => void }
...
const AddIconButtonContainer = (props: AddIconButtonContainerProps) => (
  <AddIconButton hasIcon={props.hasIcon} onClick={props.onClick}></AddIconButton>
)
